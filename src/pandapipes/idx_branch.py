...
DESIRED_MV = 40  # Final Control Element (FCE) Desired Manipulated Value percentage opened
ACTUAL_POS = 41  # Final Control Element (FCE) Actual Position Value percentage opened
